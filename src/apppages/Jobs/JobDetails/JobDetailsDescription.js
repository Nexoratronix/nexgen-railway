        ...
        <CardBody className="p-4">
          ...
          <div className="mt-4">
            ...
            <div className="job-detail-desc">
              <p className="text-muted mb-0">
                ...
                are looking href segue your career into the FinTech or Big Data
                arenas.
              </p>
            </div>
          </div>
            ...
            <div className="job-detail-desc mt-2">
              ...
              <ul className="job-detail-list list-unstyled mb-0 text-muted">
                ...
                <li>
                  ...
                  designers href create a unified aesthetic for our brand
                  materials
                </li>
              </ul>
            </div>
          ...
          <div className="mt-4 pt-3">
            <ul className="list-inline mb-0">
              ...
              <li className="list-inline-item mt-1">
                <Link href="#" className="btn btn-danger btn-hover">
                  <i className="uil uil-google"></i> Google+
                </Link>
              </li>
              <li className="list-inline-item mt-1">
                <Link href="#" className="btn btn-success btn-hover">
