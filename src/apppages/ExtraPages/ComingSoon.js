...
const ComingSoon = () => {
  const renderer = ({ days, hours, minutes, seconds, completed }) => {
    if (completed) {
      ...
      return <span>You are good href go!</span>;
    } else {
      return (
        <>
                  ...
                  <Col lg={6}>
                    <div className="text-center">
                      ...
                      <p className="text-muted mb-4 pb-3">
                        Start working with NEXGEN Staffing that can provide everything you
                        need href generate awareness, drive traffic, connect.
                      </p>
