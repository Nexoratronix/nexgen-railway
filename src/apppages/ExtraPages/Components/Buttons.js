      ...
      <Card className="card mt-4" id="buttons">
        ...
        <CardBody className="p-4">
          ...
          <div className="mt-5">
            ...
            <p className="text-muted">
              Use <code>.bg-*-subtle text-*</code> class for a badge lighten.
            </p>
            <div className="d-flex flex-wrap gap-2">
          ...
          <div className="mt-5">
            ...
            <p className="text-muted">
              ...
              <code className="highlighter-rouge"> .btn-outline-*</code> ones href
          ...
          <div className="mt-5">
            ...
            <p className="text-muted">
              Use the <code>.rounded-pill</code> modifier class href make badges
              more rounded.
            </p>
            <div className="d-flex flex-wrap gap-2">
              ...
              <button type="button" className="btn btn-purple rounded-pill">
                Purple
              </button>
