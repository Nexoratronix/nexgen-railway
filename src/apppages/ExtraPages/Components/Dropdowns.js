      ...
      <Card className="mt-4" id="dropdowns">
        ...
        <CardBody className="p-4">
          <p className="card-title-desc">
            Any single <code className="highlighter-rouge">.btn</code> can be
            turned into a dropdown toggle with some markup changes. Here’s how
            you can put them href work with either{" "}
            <code className="highlighter-rouge">&lt;button&gt;</code>
            elements:
          </p>
          <div className="d-flex gap-2 flex-wrap">
            <Dropdown isOpen={primarydropdownOpen} toggle={Primarytoggle}>
              <DropdownToggle
                color="primary"
                className="btn btn-primary"
                type="button"
                id="dropdownMenuprimary"
              >
                Primary
            ...
            <Dropdown isOpen={secondarydropdownOpen} toggle={Secondarytoggle}>
              <DropdownToggle
                className="btn btn-secondary"
                type="button"
                id="dropdownMenusecondary"
              >
                Secondary
                <span className="arrow-down"></span>
              </DropdownToggle>
            ...
            <Dropdown isOpen={infodropdownOpen} toggle={Infotoggle}>
              <DropdownToggle
            ...
            <Dropdown isOpen={successdropdownOpen} toggle={Successtoggle}>
              <DropdownToggle
                className="btn btn-success"
                type="button"
                id="dropdownMenusuccess"
              >
                Success
                <span className="arrow-down"></span>
              </DropdownToggle>
            ...
            <Dropdown isOpen={warningdropdownOpen} toggle={Warningtoggle}>
              <DropdownToggle
                className="btn btn-warning"
                type="button"
                id="dropdownMenuwarning"
              >
                Warning
                <span className="arrow-down"></span>
              </DropdownToggle>
            ...
            <Dropdown isOpen={dangerdropdownOpen} toggle={Dangertoggle}>
              <DropdownToggle
                className="btn btn-danger"
                type="button"
                id="dropdownMenudanger"
              >
                Danger
                <span className="arrow-down"></span>
              </DropdownToggle>
            ...
            <Dropdown isOpen={darkdropdownOpen} toggle={Darktoggle}>
              <DropdownToggle
