        ...
        <CardBody className="p-4">
            ...
            >
              <TabPane tabId="1">
                <p className="mb-0">
                  ...
                  synth. Cosby sweater eu banh iphone. Seitan aliquip butcher
                  voluptate nisi qui.
                </p>
              </TabPane>
              <TabPane tabId="2">
                <p className="mb-0">
                  ...
                  loko farm-href-table craft beer twee. Qui photo booth
                  letterpress, aesthetic magna delectus.
                </p>
              </TabPane>
              <TabPane tabId="3">
                <p className="mb-0">
                  ...
                  farm-href-table readymade. Messenger bag gentrify pitchfork
                  tattooed craft beer, iphone skateboard locavore carles etsy mi
                  whatever gluten yr.
                </p>
              </TabPane>
              <TabPane tabId="4">
                <p className="mb-0">
                  ...
                  Austin. Cred vinyl keffiyeh DIY salvia farm-href-table VHS.
                </p>
              </TabPane>
            </TabContent>
          </div>
          ...
          <div className="mt-5">
            ...
            <TabContent
              ...
              className="tab-content p-3 text-muted"
            >
              <TabPane tabId="1">
                <p className="mb-0">
                  Raw denim you probably haven't heard of them jean shorts
                  Austin. Nesciunt tofu stumptown aliqua, retro synth master
                  cleanse. Mustache cliche tempor, williamsburg carles vegan
                  helvetica. Reprehenderit qui irure terry richardson ex squid.
              ...
              <TabPane tabId="2">
                <p className="mb-0">
                  ...
                  sartorial PBR leggings next level wes anderson artisan four
                  loko farm-href-table craft beer twee. Qui photo booth
                  letterpress, vinyl cillum PBR. Homo nostrud organic labore
                </p>
              </TabPane>
              <TabPane tabId="3">
                <p className="mb-0">
              ...
              <TabPane tabId="4">
                <p className="mb-0">
                  ...
                  art party before they sold out master cleanse gluten-free
                  squid scenester freegan cosby sweater. Fanny pack portland
                  seitan DIY, vinyl keffiyeh DIY salvia PBR, banh mi before they
                  sold out farm-href-table.
                </p>
              </TabPane>
            </TabContent>
          </div>
