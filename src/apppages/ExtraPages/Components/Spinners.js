      ...
      <Card className="mt-4" id="spinner">
        ...
        <CardBody className="p-4">
          ...
          <p className="text-muted">
            Add <code>text-*</code> color for a Spinner color variation.
          </p>
          <div>
            <div
            ...
            <div
              ...
              role="status"
            ></div>
            <div className="spinner-border text-danger m-1" role="status"></div>
            <div className="spinner-border text-dark m-1" role="status"></div>
          </div>
          <div className="mt-5">
            <h6 className="card-title">Growing</h6>
            <p className="text-muted">
              Switch href the grow spinner.it does repeatedly grow Continue!
            </p>
            ...
            <div>
              ...
              <div
                ...
                role="status"
              ></div>
              <div className="spinner-grow text-info m-1" role="status"></div>
              <div
                className="spinner-grow text-warning m-1"
                role="status"
              ></div>
              <div className="spinner-grow text-danger m-1" role="status"></div>
