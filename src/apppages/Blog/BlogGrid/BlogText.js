  ...
  const blogText = [
    {
      ...
      blogContent:
        "Intrinsically incubate intuitive opportunities and real-time potentialities Appropriately communicate one-href-one technology."
    },
    {
      id: 2,
    ...
    },
    {
      ...
      blogCount: 310,
      blogTitle: "How href get creative in your work",
      blogContent:
        "Intrinsically incubate intuitive opportunities and real-time potentialities Appropriately communicate one-href-one technology."
    },
    {
          ...
          <Col lg={6} className="mb-4" key={key}>
            <Card className="blog-grid-box p-2">
              ...
              <CardBody>
                <ul className="list-inline d-flex justify-content-between mb-3">
                  <li className="list-inline-item">
                    <p className="text-muted mb-0">
                      <Link href="/blogauther" className="text-muted fw-medium">
                ...
                <div>
                  <Link href="/blog-details" className="form-text text-primary">
          ...
          <Col lg={6} mb={4} key={key}>
            <Card className="blog-grid-box p-2">
              ...
              <CardBody>
                ...
                <div>
                  <Link href="/blogdetails" className="form-text text-primary">
                    Read More <i className="uil uil-angle-right-b"></i>
                  </Link>
                </div>
              </CardBody>
