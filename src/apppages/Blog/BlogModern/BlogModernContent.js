    ...
    const blogModern = [
        {
            ...
            blogTitle : "How href become a best sale marketer in a year!",
        ...
        },
        {
            ...
            blogTitle : "How href Increase Trade Show Traffic",
                                ...
                                <Col lg={8} className="mt-4">
                                    <Card className="card blog-modern-box overflow-hidden">
                                        ...
                                        <div className="card-img-overlay">
                                            ...
                                            <p className="card-text text-white-50"> <Link href="/blogauther" className="text-white-50 fw-bold">Rebecca Swartz</Link> - 5 mins ago</p>
                                        </div>
                                    </Card>
                                </Col>
                                <Col lg={4} className="mt-4">
                                    <Card className="blog-modern-box overflow-hidden border-0">
                                        ...
                                        <div className="card-img-overlay">
                                            ...
                                            <p className="card-text text-white-50"> <Link href="/blogauther" className="text-white-50 fw-bold">Olivia Murphy</Link> - 30 mins ago</p>
                                        </div>
                                    </Card>
                                </Col>
                                <Col lg={5} className="mt-4">
                                    <Card className="blog-modern-box overflow-hidden border-0">
                                        ...
                                        <div className="card-img-overlay">
                                            ...
                                            <p className="card-text text-white-50"> <Link href="/blogauther" className="text-white-50 fw-bold">Adam Gibson</Link> - 3 mins ago</p>
                                        </div>
                                    </Card>
                                </Col>
                                <Col lg={7} className="mt-4">
                                    <Card className="card blog-modern-box overflow-hidden border-0">
                                        ...
                                        <div className="card-img-overlay">
                                            ...
                                            <p className="card-text text-white-50"> <Link href="/blogauther" className="text-white-50 fw-bold">Sienna Rogers</Link> - 1 hrs ago</p>
                                        </div>
                                    </Card>
                                </Col>
                                ...
                                <Col lg={4} className="mt-4" key={key}>
                                    <Card className="card blog-modern-box overflow-hidden border-0">
                                        ...
                                        <div className="card-img-overlay">
                                            ...
                                            <p className="card-text text-white-50"> <Link href="/blogauther" className="text-white-50 fw-bold">{blogModernDetails.blogAuther}</Link> - {blogModernDetails.blogTime}</p>
                                        </div>
                                    </Card>
                                </Col>
                                ))}
                                <Col lg={12} className="mt-4">
                                    <Card className="blog-modern-box overflow-hidden border-0">
                                        ...
                                        <div className="card-img-overlay">
                                            ...
                                            <p className="card-text text-white-50"> <Link href="/blogauther" className="text-white-50 fw-bold">Toby Lees</Link> - 1 months ago</p>
                                        </div>
                                    </Card>
                                </Col>
                                <Col lg={6} className="mt-4">
                                    <Card className="blog-modern-box overflow-hidden border-0">
                                        ...
                                        <div className="card-img-overlay">
                                            ...
                                            <p className="card-text text-white-50"> <Link href="/blogauther" className="text-white-50 fw-bold">Kiera Finch</Link> - 1 years ago</p>
                                        </div>
                                    </Card>
                                </Col>
                                <Col lg={6} className="mt-4">
                                    <Card className="blog-modern-box overflow-hidden border-0">
                                        ...
                                        <div className="card-img-overlay">
                                            ...
                                            <p className="card-text text-white-50"> <Link href="/blogauther" className="text-white-50 fw-bold">Alice Mellor</Link> - 3 years ago</p>
                                        </div>
                                    </Card>
                                </Col>
                            </Row>
