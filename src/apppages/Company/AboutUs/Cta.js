...
import { Container, Row, Col } from "reactstrap"; // Import Col from reactstrap
            ...
            <Col lg={7}>
              <div className="text-center">
                ...
                <p className="text-muted">
                  From staffing and software development to cloud engineering
                  and 24/7 support, we’ve got your IT needs covered. Let’s build
