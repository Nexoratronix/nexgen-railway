            ...
            <Row>
              <Col lg={2}>
                <Link to="/companydetails">
                  <img
                    src={jobVacancyNewDetails.companyImg}
                    alt=""
                ...
                <div className="mt-3 mt-lg-0">
                  <h5 className="fs-17 mb-1">
                    <Link to="/jobdetails" className="text-dark">
                      {jobVacancyNewDetails.jobDescription}
                    </Link>{" "}
                    <small className="text-muted fw-normal">
                      ({jobVacancyNewDetails.experience})
                    </small>
                  </h5>
                  <ul className="list-inline mb-0">
                    <li className="list-inline-item">
                      <p className="text-muted fs-14 mb-0">
                        {jobVacancyNewDetails.companyName}
                      </p>
                    </li>
                    <li className="list-inline-item">
                      <p className="text-muted fs-14 mb-0">
                        <i className="mdi mdi-map-marker"></i>{" "}
                        {jobVacancyNewDetails.location}
                      </p>
                    </li>
                    <li className="list-inline-item">
                      <p className="text-muted fs-14 mb-0">
                        <i className="uil uil-wallet"></i>{" "}
                        {jobVacancyNewDetails.salary}
                      </p>
                    </li>
                  </ul>
                  <div className="mt-2">
                    ...
                    {(jobVacancyNewDetails.badges || []).map(
                      (badgeInner, key) => (
                        <span
