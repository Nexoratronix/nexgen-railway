  ...
  return (
    <React.Fragment>
            ...
            <Col lg={6}>
              <div className="section-title me-lg-5">
                ...
                <p className="text-muted">
                  Welcome to NEXGEN Staffing, a premier IT staffing agency based in the United States. Our mission is to empower businesses by connecting them with exceptional IT talent that drives innovation, efficiency, and growth. With a deep understanding of the US tech market and a passion for recruitment excellence, we’ve established ourselves as a trusted partner for companies seeking to hire IT candidates who make a difference.
                </p>
      ...
      <section class="container py-5">
        ...
        <p className="lead ">
          At <span className="text-warning fw-semibold">NEXGEN Staffing</span>, our mission is clear: to provide US businesses with top-tier IT staffing services that simplify hiring and maximize results. We aim to:
        </p>
        <ul className="list-group list-group-flush">
          <li className="list-group-item border-0">
            <FontAwesomeIcon icon={faCheckCircle} className="text-primary fs-4" /> Connect employers with IT candidates who possess the skills and vision to succeed.
          </li>
          <li className="list-group-item border-0">
        ...
        <p class="lead ">
        We aspire to be the most innovative and reliable IT staffing agency in the US, setting the standard for how tech talent is sourced, screened, and placed. By staying ahead of industry trends and embracing new recruitment technologies, we’re shaping the future of IT hiring—one successful placement at a time.
        </p>
      </section>
    </React.Fragment>
  );
